...
For direct mTLS endpoints, place the CLI client certificate bundle in the gateway credential directory described in [Gateway Authentication](/how-it-works/gateways/authentication), then register or select that gateway name.
...
- To configure workspace membership and roles, refer to [Workspaces](/how-it-works/workspaces).
- To create a sandbox using the gateway, refer to [Manage Sandboxes](/how-it-works/sandboxes/overview).
