...
```shell
openshell profile import --url https://raw.githubusercontent.com/NVIDIA/OpenShell/main/providers/aws.yaml --global
```
...
signer reads. See [Manage Providers](/how-it-works/providers/overview#aws-sts).
