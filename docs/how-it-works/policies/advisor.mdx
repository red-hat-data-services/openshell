...
- Use [Customize Sandbox Policies](/how-it-works/policies/overview) for manual policy updates and L7 rule syntax.
- Use [Policy Schema Reference](/how-it-works/policies/schema) for full YAML field details.
