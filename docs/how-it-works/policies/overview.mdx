...
create and change policies, refer to [Manage Sandbox
...
Rules](/how-it-works/policies/network-rules) explains how OpenShell evaluates
rules and gives examples you can adapt.

The [Policy Schema Reference](/how-it-works/policies/schema) describes every
field in each section, and [Supervisor
...
4. OpenShell's restrictive [default
   policy](/how-it-works/policies/default-policy).
...
Policy](/how-it-works/policies/manage-policies#inspect-the-current-policy) shows
both views.
...
[Apply a Global
Policy](/how-it-works/policies/manage-policies#apply-a-global-policy) for the
commands.
