...
- Service health checks and runtime registration are not available. [Extension Authentication](/extensibility/overview#current-limitations) lists authentication limitations.
